...
public enum BreakingChangeKind {
	...
	TYPE_FORMAL_TYPE_PARAMETERS_ADDED(MUTATION, true, true),
	TYPE_FORMAL_TYPE_PARAMETERS_REMOVED(MUTATION, true, true),
	TYPE_FORMAL_TYPE_PARAMETERS_CHANGED(MUTATION, true, true),
	/**
	...
	METHOD_NOW_STATIC(MUTATION, true, true),
	...
	METHOD_FORMAL_TYPE_PARAMETERS_ADDED(MUTATION, true, true),
	METHOD_FORMAL_TYPE_PARAMETERS_REMOVED(MUTATION, true, true),
	METHOD_FORMAL_TYPE_PARAMETERS_CHANGED(MUTATION, true, true),
	METHOD_PARAMETER_GENERICS_CHANGED(MUTATION, false, true),

	FIELD_NOW_FINAL(MUTATION, true, true),
	FIELD_NOW_STATIC(MUTATION, true, true),
