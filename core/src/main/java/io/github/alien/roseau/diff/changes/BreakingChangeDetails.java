...
public sealed interface BreakingChangeDetails {
	...
	record ClassTypeChanged(Class<?> oldType, Class<?> newType) implements BreakingChangeDetails {}
	record SuperTypeRemoved(TypeReference<TypeDecl> superType) implements BreakingChangeDetails {}
	...
	record TypeFormalTypeParametersRemoved(FormalTypeParameter ftp) implements BreakingChangeDetails {}
	record TypeFormalTypeParametersAdded(FormalTypeParameter ftp) implements BreakingChangeDetails {}
	record TypeFormalTypeParametersChanged(FormalTypeParameter oldFtp, FormalTypeParameter newFtp)
		implements BreakingChangeDetails {}
	record MethodFormalTypeParametersRemoved(FormalTypeParameter ftp) implements BreakingChangeDetails {}
	record MethodFormalTypeParametersAdded(FormalTypeParameter ftp) implements BreakingChangeDetails {}
	record MethodFormalTypeParametersChanged(FormalTypeParameter oldFtp, FormalTypeParameter newFtp)
		implements BreakingChangeDetails {}
	record AnnotationMethodAddedWithoutDefault(MethodDecl newMethod) implements BreakingChangeDetails {}
}
