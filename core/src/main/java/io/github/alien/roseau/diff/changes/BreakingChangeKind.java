...
public enum BreakingChangeKind {
	...
	// Executable-related BCs
	EXECUTABLE_REMOVED(DELETION, true, true),
	EXECUTABLE_NOW_PROTECTED(MUTATION, true, true),
	EXECUTABLE_NOW_THROWS_CHECKED_EXCEPTION(MUTATION, false, true),
	EXECUTABLE_NO_LONGER_THROWS_CHECKED_EXCEPTION(MUTATION, false, true),
	EXECUTABLE_PARAMETER_GENERICS_CHANGED(MUTATION, false, true),
