...
public final class RemoveAbstractModifierClassStrategy extends RemoveModifierClassStrategy {
	public RemoveAbstractModifierClassStrategy(ClassDecl cls, NewApiQueue queue) {
	...
	protected void applyBreakToMutableApi(ApiBuilder mutableApi) throws ImpossibleChangeException {
		...
		if (mutableApi.allTypes.get(tp.getQualifiedName()) instanceof ClassBuilder mutableClass) {
