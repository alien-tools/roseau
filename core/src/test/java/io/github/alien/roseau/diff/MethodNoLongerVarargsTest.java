...
class MethodNoLongerVarargsTest {
	...
	void method_no_longer_varargs_first() {
		...
		assertBC("A", "A.m(int[])", BreakingChangeKind.METHOD_REMOVED, 2, buildDiff(v1, v2));
	}
	...
	void constructor_no_longer_varargs_last() {
		...
		assertBC("A", "A.<init>(java.lang.Object,int[])", BreakingChangeKind.CONSTRUCTOR_REMOVED, 2, buildDiff(v1, v2));
	}
