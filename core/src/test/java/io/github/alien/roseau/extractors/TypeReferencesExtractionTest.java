...
class TypeReferencesExtractionTest {
	...
	void extends_api(ApiBuilder builder) {
		...
		assertThat(api.analyzer().getExportedMethods(b)).hasSize(2 + 11);  // java.lang.Object's default
	...
	void extends_unknown(ApiBuilder builder) {
		...
		assertThat(b.getDeclaredMethods()).hasSize(1);
		assertThat(api.analyzer().getExportedMethods(b)).hasSize(1);  // java.lang.Object's default
